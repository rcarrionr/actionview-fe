          ...
          <div>
            { operateShow && hoverRowId === collection[i].id && !itemLoading &&
              <DropdownButton 
                ...
                { !isGlobal && <MenuItem eventKey='3'>Configure</MenuItem> }
                <MenuItem eventKey='4'>copy</MenuItem>
                { !isGlobal && <MenuItem eventKey='1'>edit</MenuItem> }
                { pkey === '$_sys_$' && <MenuItem eventKey='6'>View project application</MenuItem> }
    ...
    return (
      <div style={ { marginBottom: '30px' } }>
        <BootstrapTable pullRight data={ workflows } bordered={ false } hover options={ opts } trClassName='tr-top'>
          ...
          <TableHeaderColumn dataField='latest_modify'>Recently configured modification</TableHeaderColumn>
