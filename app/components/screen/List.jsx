          ...
          <div>
            { operateShow && hoverRowId === collection[i].id && !itemLoading &&
              <DropdownButton 
                ...
                { !isGlobal && <MenuItem eventKey='3'>Interface configuration</MenuItem> }
                { !isGlobal && <MenuItem eventKey='4'>Field configuration</MenuItem> }
                <MenuItem eventKey='5'>copy</MenuItem>
                { !isGlobal && <MenuItem eventKey='1'>edit</MenuItem> }
                { pkey === '$_sys_$' && <MenuItem eventKey='7'>View project application</MenuItem> }
