...
export function getAgoAt(stamptime, current_time) {
  ...
  const points = [
    { value: 365 * 24 * 60 * 60, suffix: 'Ago', max: 2 },
    { value: 30 * 24 * 60 * 60, suffix: 'Month ago', max: 11 },
    { value: 7 * 24 * 60 * 60, suffix: 'Week ago', max: 4 },
    { value: 24 * 60 * 60, suffix: 'Days ago', max: 6 },
    { value: 60 * 60, suffix: 'An hour ago', max: 23 },
    { value: 10 * 60, suffix: '0minutes ago', max: 5 }
  ];
...
export function getFileIconCss(fileName) {
  ...
  const docTypes = { 
    ...
    c: 'code', cpp: 'code', h: 'code', hpp: 'code', js: 'code', jsx: 'code', php: 'code', tpl: 'code', py: 'code', java: 'code', sh: 'code', pl: 'code', perl: 'code', go: 'code',cs: 'code', rb: 'code', html: 'code', css: 'code', asp: 'code', aspx: 'code', jsp: 'code', xml: 'code',
    pdf: 'pdf',
    txt: 'text',
