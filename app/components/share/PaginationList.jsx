    ...
    return (
      <div style={ { marginTop: '10px', height: '45px' } }>
        <div className='col-md-6' style={ { textAlign: 'left' } }>
          <span>{ _.add((curPage - 1) * sizePerPage, 1) }-{ curPage * sizePerPage >= total ? total : curPage * sizePerPage } common{ total }strip { pages }Page</span>
        </div>
        <div className='col-md-6' style={ { textAlign: 'right' } }>
          ...
          <ul className='pagination' style={ { margin: '0px' } }>
            ...
            <li key='first'>
              <span className='page-button' onClick={ this.goPage.bind(this, 1) } title='front page'>&lt;&lt;</span>
            </li> }
            { curPage-1 > 0 && pages > 1 &&
            <li key='pre'>
              <span className='page-button' onClick={ this.goPage.bind(this, curPage-1) } title='Previous page'>&lt;</span>
            </li> }
            ...
            <li key='next'>
              <span className='page-button' onClick={ this.goPage.bind(this, _.add(curPage,1)) } title='Later'>&gt;</span>
            </li> }
            { pages - paginationSize > curPage &&
            <li key='last'>
              <span className='page-button' onClick={ this.goPage.bind(this, pages) } title='last page'>&gt;&gt;</span>
            </li> }
          </ul> }
        </div>
      </div>
