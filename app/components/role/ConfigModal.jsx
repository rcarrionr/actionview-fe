        ...
        <Modal.Body style={ { maxHeight: '580px', overflow: 'auto' } }>
          <FormGroup controlId='formControlsText'>
            <CheckboxGroup 
              ...
              <ControlLabel style={ { marginTop: '10px', marginBottom: '0px' } }>question</ControlLabel>
              <ui className='list-unstyled clearfix'>
                { this.rows(Permissions.issue) }
              </ui>
              <ControlLabel style={ { marginTop: '10px', marginBottom: '0px' } }>appendix</ControlLabel>
              <ui className='list-unstyled clearfix'>
                { this.rows(Permissions.files) }
              </ui>
              <ControlLabel style={ { marginTop: '10px', marginBottom: '0px' } }>Comment</ControlLabel>
              <ui className='list-unstyled clearfix'>
